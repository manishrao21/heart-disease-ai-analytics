...
Disease dataset. This repo contains our team's Google Colab notebook and written report for
the first deliverable of the project.
...
- `AI_Analytics_Heart_Disease_Deliverable1.ipynb` — Colab notebook (with outputs)
- `AI_Analytics_Heart_Disease_Report_Deliverable1.docx` — written report
